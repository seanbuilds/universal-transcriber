"""Persistent SQLite Job Queue with WAL mode and Explicit Connection Lifetime (v2).
<!-- v2 – Context-managed connection pool and explicit database closing to prevent descriptor leaks -->
"""
...
class JobQueue:
    ...
    def _connection(self) -> Generator[sqlite3.Connection, None, None]:
        """Provide a context-managed connection guaranteed to close upon exit."""

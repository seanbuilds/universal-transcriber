"""Atomic Multi-Format Transcript Exporter with DOCX and WebVTT Support (v3).
<!-- v3 – Native python-docx executive summaries, W3C WebVTT voice span cues, atomic file replacement -->
"""
...
class TranscriptExporterV3:
    """Exports structured transcripts to Markdown, Plaintext, SRT, WebVTT, DOCX, and JSON atomically."""
    ...
    def export(
        ...
        """Save all six transcript formats to target folder atomically, returning paths of created files."""
        ...
        if docx is not None:
            ...
            # Executive Overview & Recording Metadata
            meta_p = doc.add_paragraph()
            meta_p.add_run(f"Date: {raw_date or 'N/A'}\n")
            meta_p.add_run(f"Source: {metadata.get('source', 'N/A')}\n")
            ...
            # If docx library is unavailable, create text placeholder
...
TranscriptExporter = TranscriptExporterV3
